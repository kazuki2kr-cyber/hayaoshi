    ...
    return (
        <article className="max-w-3xl mx-auto space-y-12">
            ...
            <div className="prose prose-invert prose-emerald max-w-none 
                ...
                prose-h2:text-3xl prose-h2:mt-20 prose-h2:mb-10 prose-h2:pb-6 prose-h2:border-b prose-h2:border-neutral-800
                prose-h3:text-2xl prose-h3:mt-16 prose-h3:mb-8 prose-h3:text-emerald-400
                prose-p:text-neutral-300 prose-p:leading-8 prose-p:text-lg prose-p:mb-10
                prose-li:text-neutral-300 prose-li:leading-8 prose-li:my-3
                prose-ul:my-10 prose-ul:list-disc prose-ul:pl-6
                prose-hr:my-16 prose-hr:border-neutral-800
